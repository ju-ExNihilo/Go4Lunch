...
@Keep
public class FinalRestaurant implements Parcelable {
    ...
    protected FinalRestaurant(Parcel in){
    ...
    public static final Creator<FinalRestaurant> CREATOR = new Creator<FinalRestaurant>() {
        @Override
        public FinalRestaurant createFromParcel(Parcel in) {
            return new FinalRestaurant(in);
        }

        @Override
        public FinalRestaurant[] newArray(int size) {
            return new FinalRestaurant[size];
        }
    };
